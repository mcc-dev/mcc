namespace MinecraftCommandController
{
	partial class ServerConsoleForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Size = new System.Drawing.Size(600, 19);
			...
			this.textBox2.Size = new System.Drawing.Size(599, 362);
			...
			this.label1.Text = "※この画面を閉じても起動中のサーバーは停止しません。";
			// 
			// ServerConsoleForm
			// 
			...
			this.Text = "サーバーコンソール";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ServerConsoleForm_FormClosing);
			this.Load += new System.EventHandler(this.ServerConsoleForm_Load);
