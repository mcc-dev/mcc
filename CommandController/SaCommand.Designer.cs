namespace CommandController
{
	partial class SaCommand
	{
		...
		private void InitializeComponent()
		{
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(232, 121);
			...
			this.label6.Text = "対象IDとして、以下のチャットやコマンドを実行します";
			// 
			// label5
			// 
			...
			// button15
			// 
			this.button15.Location = new System.Drawing.Point(523, 177);
			...
			this.label17.Size = new System.Drawing.Size(339, 12);
			this.label17.TabIndex = 30;
			this.label17.Text = "※注意※ フリーズや発言禁止の実行ログは鯖内全員に通知されます。";
			// 
			// label16
			// 
